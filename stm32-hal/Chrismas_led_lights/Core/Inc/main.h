...
#define Button_rigth_Pin GPIO_PIN_6
#define Button_rigth_GPIO_Port GPIOC
#define Button_rigth_EXTI_IRQn EXTI9_5_IRQn
...
#define Button_middle_Pin GPIO_PIN_15
#define Button_middle_GPIO_Port GPIOA
#define Button_middle_EXTI_IRQn EXTI15_10_IRQn
